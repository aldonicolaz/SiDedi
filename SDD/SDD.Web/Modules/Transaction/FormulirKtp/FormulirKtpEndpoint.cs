...
namespace SDD.Transaction.Endpoints
{
    ...
    using MyRepository = Repositories.FormulirKtpRepository;
    using MyRow = Entities.FormulirKtpRow;

    [RoutePrefix("Services/Transaction/FormulirKtp"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class FormulirKtpController : ServiceEndpoint
    {
