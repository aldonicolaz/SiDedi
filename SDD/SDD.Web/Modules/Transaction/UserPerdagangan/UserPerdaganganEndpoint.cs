...
namespace SDD.Transaction.Endpoints
{
    ...
    using MyRepository = Repositories.UserPerdaganganRepository;
    using MyRow = Entities.UserPerdaganganRow;

    [RoutePrefix("Services/Transaction/UserPerdagangan"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class UserPerdaganganController : ServiceEndpoint
    {
