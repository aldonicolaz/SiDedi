...
namespace SDD.Transaction.Endpoints
{
    ...
    using MyRepository = Repositories.UserPerikananPeternakanRepository;
    using MyRow = Entities.UserPerikananPeternakanRow;

    [RoutePrefix("Services/Transaction/UserPerikananPeternakan"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class UserPerikananPeternakanController : ServiceEndpoint
    {
