...
namespace SDD.Transaction.Entities
{
    ...
    public sealed class ParentMessageRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Info Broadcast"), Size(900)]
        public String Body
        {
        ...
        [DisplayName("Pilihan Pengiriman")]
        ...
        [DisplayName("Detail Broadcast"), MasterDetailRelation(foreignKey: "IdParentMessage"), NotMapped]
        ...
        [DisplayName("Author Broadcast"), ForeignKey("[dbo].[Users]", "UserId"), LeftJoin("JUsers")]
        ...
        [DisplayName("Author Broadcast"), Size(255), QuickSearch, Expression("JUsers.[DisplayName]")]
