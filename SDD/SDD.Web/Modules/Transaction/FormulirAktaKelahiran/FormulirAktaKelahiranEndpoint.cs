...
namespace SDD.Transaction.Endpoints
{
    ...
    using MyRepository = Repositories.FormulirAktaKelahiranRepository;
    using MyRow = Entities.FormulirAktaKelahiranRow;

    [RoutePrefix("Services/Transaction/FormulirAktaKelahiran"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class FormulirAktaKelahiranController : ServiceEndpoint
    {
