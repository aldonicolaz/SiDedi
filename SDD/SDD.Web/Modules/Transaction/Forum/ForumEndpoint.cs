...
namespace SDD.Transaction.Endpoints
{
    ...
    using MyRepository = Repositories.ForumRepository;
    using MyRow = Entities.ForumRow;

    [RoutePrefix("Services/Transaction/Forum"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class ForumController : ServiceEndpoint
    {
