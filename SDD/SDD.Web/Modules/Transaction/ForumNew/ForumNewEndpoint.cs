...
namespace SDD.Transaction.Endpoints
{
    ...
    using MyRepository = Repositories.ForumNewRepository;
    using MyRow = Entities.ForumNewRow;

    [RoutePrefix("Services/Transaction/ForumNew"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class ForumNewController : ServiceEndpoint
    {
