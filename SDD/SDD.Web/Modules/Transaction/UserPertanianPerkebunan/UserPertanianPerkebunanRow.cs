...
namespace SDD.Transaction.Entities
{
    ...
    [ConnectionKey("SDD_Connection"), Module("Transaction"), TableName("[dbo].[UserPertanianPerkebunan]")]
    [DisplayName("Pertanian Perkebunan"), InstanceName("Pertanian Perkebunan")]
    [ReadPermission("Transaction:UserPertanianPerkebunan")]
    [ModifyPermission("Transaction:UserPertanianPerkebunan")]
    public sealed class UserPertanianPerkebunanRow : Row, IIdRow
    {
        [DisplayName("Id User Pertanian"), Identity]
        ...
        [DisplayName("Jenis Budidaya"), ForeignKey("[dbo].[MasterHasilBudidaya]", "IdHasilBudidaya"), LeftJoin("jIdHasilBudidaya"), TextualField("IdHasilBudidayaNamaHasil")]
        ...
        [DisplayName("Detail Pertanian"), MasterDetailRelation(foreignKey: "IdUserPertanian"), NotMapped]
        public List<DetailUserPertanianRow> DetailPertanian
        {
            get { return Fields.DetailPertanian[this]; }
            set { Fields.DetailPertanian[this] = value; }
        }
        ...
        {
            get { return Fields.IdUserPertanian; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public UserPertanianPerkebunanRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
          ...
          //  public StringField IdUserOption4;
            ...
            public RowListField<DetailUserPertanianRow> DetailPertanian;
        }
    }
}
