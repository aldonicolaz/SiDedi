...
namespace SDD.Transaction.Endpoints
{
    ...
    using MyRepository = Repositories.UserPertanianPerkebunanRepository;
    using MyRow = Entities.UserPertanianPerkebunanRow;

    [RoutePrefix("Services/Transaction/UserPertanianPerkebunan"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class UserPertanianPerkebunanController : ServiceEndpoint
    {
