...
namespace SDD.Transaction.Endpoints
{
    ...
    using MyRepository = Repositories.UserNelayanRepository;
    using MyRow = Entities.UserNelayanRow;

    [RoutePrefix("Services/Transaction/UserNelayan"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class UserNelayanController : ServiceEndpoint
    {
