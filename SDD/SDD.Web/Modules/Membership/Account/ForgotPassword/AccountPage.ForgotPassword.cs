        ...
        public Result<ServiceResponse> ForgotPassword(ForgotPasswordRequest request)
        {
            return this.UseConnection("SDD_Connection", connection =>
            {
                ...
                try
                {
                    ...
                    InsertTransactionInsured_.InsertEmailLog(user.UserId.Value, user.Email, "aspan.general@gmail.com", emailBody, emailSubject, resetLink, 0);
                }
                catch (System.Exception e)
                {
                    InsertTransactionInsured_.InsertEmailLog(user.UserId.Value, user.Email, "aspan.general@gmail.com", emailBody, e.ToString(), resetLink, 0);
