...
using Administration = SDD.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: SDD.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
